...
describe('Employee test', function () {
    ...
    it('should take on assigned values', function () {
        var m = new employee_1.EmployeeModel();
    ...
    it('can be created correctly', function () { return __awaiter(_this, void 0, void 0, function () {
        var employee, EmployeeInDb;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    employee = new employee_1.EmployeeModel();
                ...
                case 1:
                    // save test post to in-memory db
                    _a.sent();
                    return [4 /*yield*/, employee_1.EmployeeModel.findOne({
                            username: 'Test UserName'
                        }).exec()];
                case 2:
                    EmployeeInDb = _a.sent();
