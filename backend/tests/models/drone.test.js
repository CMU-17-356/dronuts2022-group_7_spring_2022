...
var drone_1 = require("../../src/models/drone");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Drone.save()];
                case 1:
                    // save test post to in-memory db
                    _a.sent();
                    return [4 /*yield*/, drone_1.DroneModel.findOne({
                            status: "recharging"
                        }).exec()];
                case 2:
                    DroneInDb = _a.sent();
