...
describe('Feedback test', function () {
    var _this = this;
    var new_obj_id1 = new mongoose_1.default.Types.ObjectId();
    var new_obj_id2 = new mongoose_1.default.Types.ObjectId();
    it('should take on assigned values', function () {
        var feedback = new feedback_1.FeedbackModel();
    ...
    it('can be created correctly', function () { return __awaiter(_this, void 0, void 0, function () {
        var feedback, FeedbackInDb;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    feedback = new feedback_1.FeedbackModel();
                ...
                case 1:
                    // save test post to in-memory db
                    _a.sent();
                    return [4 /*yield*/, feedback_1.FeedbackModel.findOne({
                            username: 'Test UserName',
                        }).exec()];
                case 2:
                    FeedbackInDb = _a.sent();
